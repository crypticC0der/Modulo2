...
public class RocketAttack : RangedAttack {
    public override void AddAttack(Combatant c) { c.AddAttack<RocketAttack>(); }
    ...
    public override void AtFunc(Vector3 d) {
        ProcOnCollsion p =
            basicBullet(this, "assets/rocket",
...
public class RocketProc : Proc {
    public override void OnProc(Damageable d) {
        Effects.Explode(d.transform.position, perent.damage() / 10, this,
